...
const StyledDatePickerWrapper = styled.div`
  ...
  .react-datepicker, .react-datepicker__day, .react-datepicker__time-list-item, .custom-header {
  ...
  return (
    <StyledDatePickerWrapper>
      <DatePicker
        ...
        customTimeInput={<ExampleCustomTimeInput date={startDate} value={startDate} />}
      />
      {props.children}
    </StyledDatePickerWrapper>
  )
